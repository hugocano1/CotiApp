// src/screens/seller/ProfileScreen.tsx
import React from 'react';
// ... (Importa los mismos componentes que en BuyerProfileScreen)
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View style={styles.headerContainer}>
          <Avatar size={100} rounded source={{ uri: profile.store_logo_url || undefined }} title={(profile.nombre || 'C').substring(0, 2).toUpperCase()} containerStyle={styles.avatar} />
          <Text style={styles.name}>{profile.nombre || 'Vendedor'}</Text>
        ...
        <Card containerStyle={styles.card}>
          ...
          <Card.Divider />
          <InfoItem icon="store" text="Descripción" value={profile.store_description || 'No especificada'} />
        ...
        <Card containerStyle={styles.card}>
          ...
          <Card.Divider />
          <ListItem icon="pencil-outline" text="Editar Perfil y Tienda" onPress={() => { /* Lógica futura de edición */ }} />
        </Card>
